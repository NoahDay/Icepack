...
!BOP
!
! !MODULE: m_fzero - find zero of scalar function
!
! !DESCRIPTION:
!
! blah blah blah \\
!
! !REVISION HISTORY:
!  SVN:$Id: m_fzero.F90 2013-09-02 13:48:20 lgb566 $
!
! author: V Arious, Uni Somewhere
!
! !INTERFACE:
!
 module m_fzero
...
!BOP
!
! !ROUTINE: glomin  - seeks a global minimum of a function F(X) in an interval [A,B]
!
! !DESCRIPTION:
!
!  blah blah blah
...
!BOP
!
! !ROUTINE: local_min  - seeks a local minimum of a function F(X) in an interval [A,B]
!
! !DESCRIPTION:
!
!  blah blah blah
...
!BOP
!
! !ROUTINE: zero  - seeks the root of a function F(X) in an interval [A,B]
!
! !DESCRIPTION:
!
!  blah blah blah
